...
<div class="container">
    <div class="row">
        ...
        <div class="col-3 mt-5">
        <a href="./success_order.php" class="btn btn-lg bg-success text-light w-100 shadow">
                <h3>เสร็จสิ้น</h3>
                </a>   
        </div>

        <h3 class="mt-5">เสร็จสิ้น</h3>
        <hr>
        <!-- WHile -->
         <?php 
        ...
        <table class="table">
            <tbody>
                <?php if($res['order_status'] == "ส่งสำเร็จ"){ 
                    if($_SESSION['id_user'] == $res['rider_id'] || $_SESSION['id_user'] == $res['vendor_owner'] ){?>
                <tr>
