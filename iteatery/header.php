...
?>
    <div class="container-fluid shadow">
        ...
        <a href="./index.php" class="navbar-brand"><h2 class="" style="color:#008556;">IT<span class="text-dark">    Eatery</span></h2></a>
    ...
    <?php }elseif($_SESSION['user_type'] == "user"){?>
        ...
        <div class="navbar-collapse d-flex flex-row-reverse" id="navbarNav">
            <ul class="navbar-nav fw-bolder">
                <li class="nav-item">
                    <a href="" class="nav-link">รับรหัสโปรโมชั่น</a>
                </li>
                ...
                <img class="d-block" style="width:30px; height:30px;" src="./user_img/<?php echo($res['user_img'])?>" alt=""> <span> <?php echo($res['fname']);?></span>
          </a>
        ...
        <div class="navbar-collapse d-flex flex-row-reverse" id="navbarNav">
            <ul class="navbar-nav fw-bolder">
                <li class="nav-item">
                    <a href="./order_vendor.php" class="nav-link">จัดเตรียมอาหาร</a>
                </li>
                <li class="nav-item">
